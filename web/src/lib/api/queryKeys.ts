...
export const qk = {
  ...
  members: (filters?: Record<string, unknown>) => (filters ? (['members', filters] as const) : (['members'] as const)),
  ...
  income: (filters?: Record<string, unknown>) => (filters ? (['income', filters] as const) : (['income'] as const)),
  expenses: (filters?: Record<string, unknown>) => (filters ? (['expenses', filters] as const) : (['expenses'] as const)),
